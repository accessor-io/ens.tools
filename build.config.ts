...
/**
 * Marketplace-only configuration example
 * Uncomment and use this if you only want the marketplace
 */
 ...
 * Change this to use a different preset or modify the default
 */
