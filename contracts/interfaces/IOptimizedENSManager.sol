...
/**
 * @title IOptimizedENSManager
 * @dev Interface for the Optimized ENS Manager
 * @notice Defines the contract interface for gas-optimized ENS domain management
 */
interface IOptimizedENSManager {
    // Structs
