...
export function ENSIPXRegistration() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const ensName = metadata.ensRoot || `${role}.${org}.cns.eth`;
  ...
  const canProceedFromBasic = org && protocol && role && version && contractAddress;
  const canProceedFromClassification = category;
    ...
    <div className="space-y-6">
      ...
      <Card className="border-2">
        <CardContent className="pt-6">
          <Breadcrumb
            items={['basic', 'classification', 'security', 'lifecycle', 'review'].map((s, idx) => ({
              label: s.charAt(0).toUpperCase() + s.slice(1),
              onClick: idx <= ['basic', 'classification', 'security', 'lifecycle', 'review'].indexOf(step) ? () => setStep(s as any) : undefined,
              disabled: idx > ['basic', 'classification', 'security', 'lifecycle', 'review'].indexOf(step),
            }))}
            className="mb-4"
          />
          <div className="flex items-center justify-between">
            {['basic', 'classification', 'security', 'lifecycle', 'review'].map((s, idx) => (
              <div key={s} className="flex items-center">
                <div
                  className={`flex items-center justify-center w-10 h-10 rounded-full border-2 ${
                    step === s
                      ? 'border-blue-600 bg-blue-50 text-blue-600'
                      : idx < ['basic', 'classification', 'security', 'lifecycle', 'review'].indexOf(step)
                ...
                {idx < 4 && <div className="w-12 h-0.5 bg-slate-200 mx-4 hidden md:block" />}
              </div>
            ))}
          </div>
        </CardContent>
      ...
      <Tabs value={step} onValueChange={(v: any) => setStep(v as any)}>
        ...
        <TabsContent value="basic">
          <Card className="border-2">
            <CardHeader>
              ...
              <CardDescription>
                Core contract identification following org.protocol.category.role.version.chainId grammar
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between">
                ...
                <Button
                  ...
                  disabled={!canProceedFromClassification}
                >
                  Next: Security
                </Button>
              </div>
          ...
          <Card className="border-2">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div>
                  <Label className="text-slate-600">ENS Root Domain</Label>
                  <p className="text-slate-900 font-mono">
                ...
                <div>
                  ...
                  <p className="text-slate-900 break-all font-mono">{contractAddress}</p>
                </div>
              ...
              <div className="flex justify-between gap-2">
                <Button variant="outline" onClick={() => setStep('lifecycle')}>
                  Back
                </Button>
                <Button
